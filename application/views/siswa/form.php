...
<body>
	...
	<a class="btn btn-xs btn-success" href="<?php echo base_url('assets\format_excel\siswa\format_siswa.xlsx')?>" download> <i class="fa fa-download"> DOWNLOAD FORMAT</i> </a>
	
	<br>
	<br>

	<!-- Buat sebuah tag form dan arahkan action nya ke controller ini lagi -->
	<form method="post" class="md-form" action="<?php echo base_url("index.php/siswa/form"); ?>" enctype="multipart/form-data">
		<!--
		...
		-->
		<br>
		<a href="<?php echo base_url('index.php/siswa') ?>" class='btn btn-s btn-danger'>Cancel</a>
	...
	if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
		...
		<div class='panel-tools'>";
			echo "<a class='btn btn-xs btn-link' href='http://localhost/project-akademi-sekolah/index.php/siswa/add'> <i class='fa fa-plus'></i> </a>
		...
		foreach($sheet as $row){
			...
			if($nis == "" && $nama_lengkap == ""  && $gender == "" && $tanggal_lahir == "" && $tempat_lahir == "" && $id_agama == "" && $id_rombel == "")
			...
			if($numrow > 1){
				...
				$id_td = ( ! empty($nis))? "" : " style='background: #E07171;'"; // Jika NIS kosong, beri warna merah
				...
				if($nis == "" or $nama_lengkap == "" or $gender == "" or $tanggal_lahir == "" or $tempat_lahir == "" or $id_agama == "" or $id_rombel == ""){
					$kosong++; // Tambah 1 variabel $kosong
				}

				echo "<tr>";
				echo "<td".$id_td.">".$nis."</td>";
		...
		<?php
			echo "<a href='".base_url("index.php/siswa/form")."' class='btn btn-s btn-danger'>Cancel</a>";
