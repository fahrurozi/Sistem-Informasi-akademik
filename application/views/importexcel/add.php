                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="id_jurusan" placeholder="ID JURUSAN" id="form-field-1" class="form-control" title="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="form-field-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="nama_jurusan" placeholder="NAMA JURUSAN" id="form-field-1" class="form-control" title="">
                                        </div>
                                    </div>
                                    <div class="form-group">
