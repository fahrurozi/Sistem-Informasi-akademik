...
<body>
	...
	<a class="btn btn-xs btn-success" href="<?php echo base_url('assets\format_excel\jurusan.xlsx')?>"> <i class="fa fa-download"> DOWNLOAD FORMAT</i> </a>
	<br>
	<br>

	<!-- Buat sebuah tag form dan arahkan action nya ke controller ini lagi -->
	<form method="post" class="md-form" action="<?php echo base_url("index.php/importexcel/form"); ?>" enctype="multipart/form-data">
		<!--
		...
		-->
		<br>
		<a href="<?php echo base_url('index.php/importexcel') ?>" class='btn btn-s btn-danger'>Cancel</a>
	...
	if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
		...
		echo "<form method='post' action='".base_url("index.php/importexcel/import")."'>";
		...
		<?php
			echo "<a href='".base_url("index.php/importexcel/form")."' class='btn btn-s btn-danger'>Cancel</a>";
