		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<div class="panel-tools">
					<a class="btn btn-xs btn-danger" style="margin-right: 20px;" href="<?php echo base_url("index.php/rombel/form"); ?>"> <i class="fa fa-upload"> UPLOAD EXCEL</i> </a>
					<a class="btn btn-xs btn-link" href="rombel/add"> <i class="fa fa-plus"></i> </a>
