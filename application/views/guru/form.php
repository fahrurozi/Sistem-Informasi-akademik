...
<body>
	...
	<a class="btn btn-xs btn-success" href="<?php echo base_url('assets\format_excel\guru\format_guru.xlsx')?>"> <i class="fa fa-download"> DOWNLOAD FORMAT</i> </a>
	<br>
	<br>

	<!-- Buat sebuah tag form dan arahkan action nya ke controller ini lagi -->
	<form method="post" class="md-form" action="<?php echo base_url("index.php/guru/form"); ?>" enctype="multipart/form-data">
		<!--
		...
		-->
		<br>
		<a href="<?php echo base_url('index.php/guru') ?>" class='btn btn-s btn-danger'>Cancel</a>
	...
	if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
		...
		<div class='panel-tools'>";
			echo "<a class='btn btn-xs btn-link' href='http://localhost/project-akademi-sekolah/index.php/guru/add'> <i class='fa fa-plus'></i> </a>
		...
		foreach($sheet as $row){
			...
			$nama_guru = $row['B']; // Ambil data nama
			$gender = $row['C'];


			// Cek jika semua data tidak diisi
			if($nip == "" && $nama_guru == ""  && $gender == "")
            ...
            if($numrow > 1){
				...
				$nama_td = ( ! empty($nama_guru))? "" : " style='background: #E07171;'"; // Jika Nama kosong, beri warna merah
				$gender_td = ( ! empty($gender))? "" : " style='background: #E07171;'";

				// Jika salah satu data ada yang kosong
				if($nip == "" or $nama_guru == "" or $gender == "" ){
		...
		<?php
			echo "<a href='".base_url("index.php/guru/form")."' class='btn btn-s btn-danger'>Cancel</a>";
