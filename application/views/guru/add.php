                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="nip" placeholder="NIP" id="form-field-1" class="form-control" title="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="form-field-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="nama_guru" placeholder="NAMA GURU" id="form-field-1" class="form-control" title="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php echo 
                                            form_dropdown('gender',array('L'=>'Laki-laki','P'=>'Perempuan'),'',"class='form-control'");
                                              ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
